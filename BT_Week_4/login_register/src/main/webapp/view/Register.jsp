...
button#btn-login:hover {
	...
	<div id="wrapper">
		<form action="/login_register/Register/home" method="post">
			<h3>Sign up</h3>
			...
			<div class="form-group">
				<input type="text" name="user" required> <label for="">Username</label>
			</div>
			...
			<div class="form-group">
				<input type="password" name="psw" required> <label for="">Password</label>
			</div>
			...
			<button type="button" id="btn-login"
				onclick="window.location.href='login.jsp'">Log in</button>
		</form>
	</div>
